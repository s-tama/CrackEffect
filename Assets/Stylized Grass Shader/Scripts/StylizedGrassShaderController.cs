...
namespace AwesomeTechnologies.Shaders
{
    public class StylizedGrassShaderController : IShaderController
    {
        ...
        public void CreateDefaultSettings(Material[] materials)
        {
            ...
            Settings.AddFloatProperty("_NormalsFlatten", "Flatten normals (lighting)", "", ShaderControllerSettings.GetVector4FromMaterials(materials, "_NormalParams").y, 0, 1);
            Settings.AddFloatProperty("_NormalsSpherify", "Spherify normals", "", ShaderControllerSettings.GetVector4FromMaterials(materials, "_NormalParams").x, 0, 1);
