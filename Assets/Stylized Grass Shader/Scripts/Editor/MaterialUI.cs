    ...
    public class MaterialUI : ShaderGUI
    {
        ...
        private void DrawColor()
        {
            ...
            if (EditorGUILayout.BeginFadeGroup(colorSection.anim.faded))
            {
                ...
                UI.Material.DrawColorField(color, false, tooltip:"This color is multiplied with the texture. Use a white texture to color the grass by this value entirely.");
                ...
                UI.Material.DrawColorField(_EmissionColor, true, tooltip:"Color is added on top of everything, and contributes to HDR");
